...
Contributing to `ts-jhu-covid19` is fairly easy. This document shows you how to
get the project, run all provided tests and generate a production-ready build.

It also covers provided tasks that help you develop with `ts-jhu-covid19`.
...
To get the source of `ts-jhu-covid19`, clone the git repository via:
...
- Commit your changes
  ...
  - `ts-jhu-covid19` uses [conventional-changelog-cli](https://www.npmjs.com/package/conventional-changelog-cli).
